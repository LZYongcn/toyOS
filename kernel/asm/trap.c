...
void handle_divide_error(unsigned long rsp, unsigned long error_code) {
  ...
  color_printfk(RED,BLACK,"handle_divide_error(0),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}

void handle_debug(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
...
void handle_int3(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
...
void handle_overflow(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_overflow(4),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}

void handle_bounds(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_bounds(5),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}

void handle_undefined_opcode(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_undefined_opcode(6),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}

void handle_dev_not_available(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_dev_not_available(7),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}
...
void handle_double_fault(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_double_fault(8),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}

void handle_coprocessor_segment_overrun(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_coprocessor_segment_overrun(9),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}
...
void handle_invalid_TSS(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_invalid_TSS(10),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);

  if (error_code & 0x01) {
    // color_printfk(RED,BLACK,"The exception occurred during delivery of an event external to the program,such
    // as an interrupt or an earlier exception.\n");
...
void handle_segment_not_present(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_segment_not_present(11),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
...
void handle_stack_segment_fault(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_stack_segment_fault(12),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
...
void handle_general_protection(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_general_protection(13),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
...
void handle_page_fault(unsigned long rsp, unsigned long error_code) {
  ...
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_page_fault(14),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
...
void handle_x87_FPU_error(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_x87_FPU_error(16),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}
...
void handle_alignment_check(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_alignment_check(17),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}
...
void handle_machine_check(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_machine_check(18),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}

void handle_SIMD_exception(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_SIMD_exception(19),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}
...
void handle_virtualization_exception(unsigned long rsp, unsigned long error_code) {
  unsigned long* p = NULL;
  p = (unsigned long*)(rsp + 0x98);
  color_printfk(RED,BLACK,"handle_virtualization_exception(20),ERROR_CODE:%#018lx,RSP:%#018lx,RIP:%#018lx\n",error_code , rsp , *p);
  while (1) {};
}
